//
//  CityTourArrivalTicketPresenter.swift
//  Travelly
//
...
class CityTourArrivalTicketPresenter: TicketsFeedPresenterProtocol, TicketsFilterPresenterProtocol {
    ...
    func selectTicket(at index: Int) {
        let ticketsData = interactor.getTicketsData(at: index)
        self.cityTourInfoDelegate.updateArrivalTicket(ticketData: ticketsData)
