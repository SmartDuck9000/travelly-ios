//
//  CityTourDeparturePresenter.swift
//  Travelly
//
...
class CityTourDepartureTicketPresenter: TicketsFeedPresenterProtocol, TicketsFilterPresenterProtocol {
    ...
    init(
        view: TicketsFeedViewController,
        router: TicketsFeedRouterProtocol,
        interactor: TicketsFeedInteractorProtocol,
    ...
    func selectTicket(at index: Int) {
        let ticketsData = interactor.getTicketsData(at: index)
        self.cityTourInfoDelegate.updateDepartureTicket(ticketData: ticketsData)
