...
class CityTourHotelPresenter: HotelFeedPresenterProtocol, HotelFilterPresenterProtocol {
    ...
    init(
        view: HotelFeedViewController,
        router: HotelFeedRouterProtocol,
        interactor: HotelFeedInteractorProtocol,
    ...
    func selectHotel(at index: Int) {
        let hotelData = interactor.getHotelData(at: index)
        self.cityTourInfoDelegate.updateHotel(hotelData: hotelData)
